<template>
  <div class="areaBox">
    <el-input placeholder="输入关键字进行过滤" v-model="filterText" clearable size="small" />
    <el-tree class="filter-tree" :data="areaList" :props="defaultProps" :default-expand-all="true" :filter-node-method="filterNode" ref="tree" @node-click="handleNodeClick" :highlight-current="true" node-key="dr_unit_id" :expand-on-click-node="false">
    </el-tree>
  </div>
</template>
<script>
