  ...
  <div class="dashboard-container">
    <el-row :gutter="20"
      ...
      <el-col :span="24"
                ...
                <el-col :span="8">
                  <el-form-item label="巡检类型">
                    <el-select size="small"
                               ...
                               placeholder="请选择"
                               clearable>
                      <el-option v-for="item in drPatrolPlanTypes"
                                 :key="item.value"
                                 :label="item.label"
                                 :value="item.value">
                      </el-option>
        ...
        <el-table  :stripe="true"
          ...
          <el-table-column prop="drPatrolPlanName"
                           label="巡查计划名称"
                           align="center"
                           show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="drPatrolPlanType"
                           label="巡查周期"
                           align="center"
                           show-overflow-tooltip>
          ...
          <el-table-column prop="drPatrolPlanStart"
                           label="开始时间"
                           align="center"
                           show-overflow-tooltip>
            <template slot-scope="scope">
          ...
          <el-table-column prop="drPatrolPlanEnd"
                           label="结束时间"
                           align="center"
                           show-overflow-tooltip>
            <template slot-scope="scope">
          ...
          <el-table-column prop="drUserName"
                           label="巡查员"
                           align="center"
                           show-overflow-tooltip />
          ...
          <el-table-column label="操作"
            ...
            <template slot-scope="scope">
              ...
              <el-button type="primary"
                         size="small"
                         @click="openLog(scope.row)">巡查日志</el-button>
            </template>
          </el-table-column>
        </el-table>
    ...
    <el-dialog :close-on-click-modal="false"
      ...
      <el-form :model="ruleForm"
        ...
        <el-form-item label="巡检计划名称"
          ...
          <el-input clearable
                    size="small"
                    v-model="ruleForm.drPatrolPlanName"></el-input>
        </el-form-item>
        <el-form-item label="巡检计划类型"
                      prop="drPatrolPlanType">
          <el-select v-model="ruleForm.drPatrolPlanType"
                     size="small"
                     placeholder="请选择"
                     style="width: 100%">
            <el-option v-for="item in drPatrolPlanTypes"
        ...
        <el-form-item label="所属单位"
                      prop="drPatrolPlanUnit">
          <el-cascader @change="changeUnit"
                       :options="units"
                       :props="{
              checkStrictly: true,
              value: 'dr_unit_id',
        ...
        <el-form-item label="巡检人员"
                      prop="drPatrolPlanPerson">
          <el-select v-model="ruleForm.drPatrolPlanPerson"
                     size="small"
                     placeholder="请选择"
                     style="width: 100%">
        ...
        <el-form-item label="巡检计划开始时间"
          ...
          <el-date-picker v-model="ruleForm.drPatrolPlanStart"
        ...
        <el-form-item label="巡检计划结束时间"
                      prop="drPatrolPlanEnd">
          <el-date-picker v-model="ruleForm.drPatrolPlanEnd"
                          type="datetime"
                          placeholder="选择日期时间"
                          size="small"
                          value-format="timestamp">
    ...
    <el-dialog title="巡检日志"
      ...
      <el-table :data="logList"
                ...
                :header-cell-style="{background:'#f5f7fa',color:'#606266'}"
                size="mini">
        <el-table-column prop="dr_patrol_plan_name"
                         label="巡检名称"
                         align="center"
                         show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="dr_patrol_plan_time"
                         label="巡检标签"
                         align="center"
                         show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="dr_time"
                         label="巡检时间"
                         align="center"
                         show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="dr_patrol_finish_status"
                         label="巡检状态"
                         align="center"
                         show-overflow-tooltip>
          <template slot-scope="scope">
