          ...
          >
            <template slot-scope="scope">
              <el-button
                ...
                >{{ scope.row.dr_user_name }}</el-button
              >
            </template>
          </el-table-column>
          <el-table-column
      ...
      >
        ...
        <el-form-item label="用户账号" prop="dr_login_account">
          <el-input
            clearable
            size="mini"
            v-model="ruleForm.dr_login_account"
          ></el-input>
        </el-form-item>
        <el-form-item label="密码" :prop="isEdit ? '' : 'dr_login_pass'">
          <el-input
            clearable
            size="mini"
            v-model="ruleForm.dr_login_pass"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="邮箱" prop="dr_user_email">
          <el-input
            clearable
            size="mini"
            v-model="ruleForm.dr_user_email"
          ></el-input>
        </el-form-item>
        <el-form-item label="手机号码" prop="dr_user_phone">
          <el-input
            clearable
            size="mini"
            v-model="ruleForm.dr_user_phone"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="用户类型" prop="dr_is_admin">
          <el-radio-group v-model="ruleForm.dr_is_admin">
            ...
            <el-radio
              :label="'service'"
              v-if="$bus.user.dr_is_admin !== 'commonly'"
              >运维用户</el-radio
            >
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="关联角色" prop="dr_role">
          <el-checkbox-group v-model="ruleForm.dr_role">
            <el-checkbox
              :key="item.dr_role_key"
              :label="item.dr_role_key"
              v-for="item in roles"
              >{{ item.dr_role_value }}</el-checkbox
            >
          </el-checkbox-group>
        </el-form-item>
      </el-form>
