<template>
  <div class="">
    <el-row :gutter="20" type="flex">
      ...
      <el-col :span="18" style="flex:1">
        ...
        <el-table :data="tableData" :height="tableHeight" border size="mini" v-loading="loading" :header-cell-style="{background:'#f5f7fa',color:'#606266'}" highlight-current-row style="width: 100%" empty-text="暂无数据" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="dr_user_phone" label="手机号" align="center" width="100" show-overflow-tooltip />
          ...
          <el-table-column prop="address" label="用户业务" align="center"  show-overflow-tooltip>
            <template slot-scope="scope">
              <span>个人业务</span>
            </template>
          </el-table-column>
          <el-table-column prop="dr_name" label="用户角色" align="center" show-overflow-tooltip />
          <el-table-column prop="dr_register_time" label="创建时间" align="center" show-overflow-tooltip>
            <template slot-scope="scope">
              <span>{{formatDateTime(scope.row.dr_register_time*1000)}}</span>
            </template>
          </el-table-column>
    ...
    <!-- 新增 -->
    <el-dialog :close-on-click-modal="false" title="添加客户" :visible.sync="dialogVisible" width="50%">
